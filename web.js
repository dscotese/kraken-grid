...
//            readme = rf.substr(rf.lastIndexOf("## Usage"));
    ...
    function AssetsTable() {
        const Savs = portfolio.Savings; let assets;
            const total = portfolio.Allocation.getTotal();
            let tbody = "";
            let ktks = tkrs ? Object.keys(tkrs) : [];
            let ret = ""; const rows = []; // rows is an associative array of object arrays.
            let tkr; let amt; let ki; let label; let sav; // ktks is "Known Tickers"
